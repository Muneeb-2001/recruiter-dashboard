      ...
      <div style={styles.sidebar}>
        ...
        <div style={styles.sidebarScoreGuide}>
          ...
          <div style={styles.sidebarGuideItem}>
            ...
            <span style={styles.sidebarGuideText}><strong>85—</strong> —</span>
          </div>
          <div style={styles.sidebarGuideItem}>
            <span style={{...styles.sidebarDot, backgroundColor: '#3b82f6'}}></span>
            <span style={styles.sidebarGuideText}><strong>65—</strong> —</span>
          </div>
          <div style={styles.sidebarGuideItem}>
            <span style={{...styles.sidebarDot, backgroundColor: '#f59e0b'}}></span>
            <span style={styles.sidebarGuideText}><strong>50—</strong> —</span>
          </div>
          <div style={styles.sidebarGuideItem}>
            <span style={{...styles.sidebarDot, backgroundColor: '#ef4444'}}></span>
            <span style={styles.sidebarGuideText}><strong>Below 50</strong> —</span>
          </div>
        </div>
      </div>
